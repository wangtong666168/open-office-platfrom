package com.open.gather.common.db.config;


import javax.sql.DataSource;

import com.open.gather.common.db.config.util.DataSourceKey;
import com.open.gather.common.db.config.util.DynamicDataSource;
